package hu.kalmancheysandor.applications.dominions.apis.server.ai.common.proxy.otto;
...
@FeignClient(name="server-ai-otto-agent")
public interface OttoAiAgenServerProxy {
    @PostMapping("/call")
