package hu.kalmancheysandor.applications.dominions.apis.server.ai.common.proxy.helga;
...
@FeignClient(name="server-ai-helga-agent")
public interface HelgaAiAgentServerProxy {
    @PostMapping("/call")
