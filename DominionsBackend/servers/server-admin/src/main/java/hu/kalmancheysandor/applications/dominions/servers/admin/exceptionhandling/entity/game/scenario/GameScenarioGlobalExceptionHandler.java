...
public class GameScenarioGlobalExceptionHandler {
    ...
    @ExceptionHandler(GameScenarioInvalidGameMapContentException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public GeneralFailureResponse handle(GameScenarioInvalidGameMapContentException exception) {
        // Logging
        log.warn("GameScenario map field is invalid: {}");
