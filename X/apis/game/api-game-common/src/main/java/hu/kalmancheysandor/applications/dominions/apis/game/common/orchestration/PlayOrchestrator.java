    ...
    private void addMissingAiPlayers() {
        for (int aiPlayerIndex : new HashSet<>(this.playState.aiPlayerSlot)) {
            ...
            if (gameMapConfigurationPlayer.getEngine() == GameMapEngineType.AI_OTTO) {
                player = new ArtificialPlayer(aiPlayerIndex, "AI-OTTO-UserUuid", "Mr Otto Ai " + aiPlayerIndex, GameMapEngineType.AI_OTTO, "AI-OTTO-EndpointKey-" + aiPlayerIndex);
            } else if (gameMapConfigurationPlayer.getEngine() == GameMapEngineType.AI_EGON) {
                player = new ArtificialPlayer(aiPlayerIndex, "AI-EGON-UserUuid", "Mr Egon Ai " + aiPlayerIndex, GameMapEngineType.AI_EGON, "AI-EGON-EndpointKey-" + aiPlayerIndex);
            }  else if (gameMapConfigurationPlayer.getEngine() == GameMapEngineType.AI_LIZ) {
                player = new ArtificialPlayer(aiPlayerIndex, "AI-LIZ-UserUuid", "Miss Liz Ai " + aiPlayerIndex, GameMapEngineType.AI_LIZ, "AI-LIZ-EndpointKey-" + aiPlayerIndex);
            } else if (gameMapConfigurationPlayer.getEngine() == GameMapEngineType.AI_HUGO) {
                player = new ArtificialPlayer(aiPlayerIndex, "AI-HUGO-UserUuid", "Mr Hugo Ai " + aiPlayerIndex, GameMapEngineType.AI_HUGO, "AI-HUGO-EndpointKey-" + aiPlayerIndex);
            } else if (gameMapConfigurationPlayer.getEngine() == GameMapEngineType.AI_HELGA) {
                player = new ArtificialPlayer(aiPlayerIndex, "AI-HELGA-UserUuid", "Miss Helga Ai " + aiPlayerIndex, GameMapEngineType.AI_HELGA, "AI-HELGA-EndpointKey-" + aiPlayerIndex);
            }
            else {
