...
@Data
@NoArgsConstructor
public class NeoStateOpponent implements Serializable {
    private String name;
    ...
    public NeoStateOpponent(String name, GameMapPlayerType type, GameMapEngineType engine, Integer reserveSize) {
        init(name, type, engine, reserveSize, true);
    }

    public NeoStateOpponent(String name, GameMapPlayerType type, GameMapEngineType engine, Integer reserveSize, boolean alive) {
