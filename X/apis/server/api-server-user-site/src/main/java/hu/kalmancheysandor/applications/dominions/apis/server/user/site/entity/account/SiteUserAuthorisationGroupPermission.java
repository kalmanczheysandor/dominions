...
@Entity
@IdClass(SiteUserAuthorisationGroupPermission.PrimaryKey.class)
@Table(name = "t_site_user_authorisation_group_permission")
@Data
@NoArgsConstructor
public class SiteUserAuthorisationGroupPermission {
...
//    private UserAuthorisationGroup group;
    ...
    public SiteUserAuthorisationGroupPermission(String target, Integer groupId, boolean permissionIsView, boolean permissionIsAdd, boolean permissionIsEdit, boolean permissionIsDelete) {
    ...
    public boolean equals(Object o) {
        ...
        SiteUserAuthorisationGroupPermission that = (SiteUserAuthorisationGroupPermission) o;
