package hu.kalmancheysandor.applications.dominions.service.account.user;
...
public class UserService {
    ...
    public UserResponse accessUser(String uuid) {
        ...
        // Generate response
        List<String> groupUuidList = user.getUserGroups().stream()
