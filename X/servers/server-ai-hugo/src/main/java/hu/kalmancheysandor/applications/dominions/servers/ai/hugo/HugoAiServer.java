package hu.kalmancheysandor.applications.dominions.servers.ai.hugo;
...
import hu.kalmancheysandor.applications.dominions.apis.ai.hugo.HugoAiBasicEngine;
...
@EnableAsync
@EnableFeignClients
public class HugoAiServer {
    public static void main(String[] args) {
        SpringApplication.run(HugoAiServer.class, args);
    }
