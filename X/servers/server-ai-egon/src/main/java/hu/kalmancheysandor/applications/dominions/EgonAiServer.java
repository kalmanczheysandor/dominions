package hu.kalmancheysandor.applications.dominions;
...
@SpringBootApplication(scanBasePackages = {
    ...
    "hu.kalmancheysandor.applications.dominions.servers.ai.egon"
})
@EnableAsync
@EnableFeignClients
public class EgonAiServer {
    public static void main(String[] args) {
        SpringApplication.run(EgonAiServer.class, args);
    }
