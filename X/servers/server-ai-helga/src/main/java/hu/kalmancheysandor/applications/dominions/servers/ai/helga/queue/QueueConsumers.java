package hu.kalmancheysandor.applications.dominions.servers.ai.helga.queue;
...
public class QueueConsumers {
    ...
    @Bean
    public Consumer<AiHistoryQueueItem> queueHistoryBroadcast(HelgaAiService service) {
