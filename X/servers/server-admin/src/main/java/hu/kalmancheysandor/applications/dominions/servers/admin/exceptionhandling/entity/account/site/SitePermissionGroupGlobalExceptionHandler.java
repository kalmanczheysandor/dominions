...
import hu.kalmancheysandor.applications.dominions.apis.server.user.site.service.account.permission.exception.*;
...
public class SitePermissionGroupGlobalExceptionHandler {
    
    @ExceptionHandler(SitePermissionGroupNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public GeneralFailureResponse handle(SitePermissionGroupNotFoundException exception) {
        // Logging
    ...
    @ExceptionHandler(SitePermissionGroupNotFoundByUuidException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public GeneralFailureResponse handle(SitePermissionGroupNotFoundByUuidException exception) {
        // Logging
    ...
    @ExceptionHandler(SitePermissionGroupNameIsReservedException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public GeneralFailureResponse handle(SitePermissionGroupNameIsReservedException exception) {
        // Logging
    ...
    @ExceptionHandler(SitePermissionGroupForeignKeyViolationException.class)
    @ResponseStatus(HttpStatus.CONFLICT)  // If Integrity conflict
    public GeneralErrorResponse handle(SitePermissionGroupForeignKeyViolationException exception) {
        // Logging
    ...
    @ExceptionHandler(SitePermissionGroupAssociationRestrictedException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public GeneralFailureResponse handle(SitePermissionGroupAssociationRestrictedException exception) {
        // Logging
    ...
    @ExceptionHandler(SitePermissionGroupReferencedElsewhereException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public GeneralFailureResponse handle(SitePermissionGroupReferencedElsewhereException exception) {
        // Logging
