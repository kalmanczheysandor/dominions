        ...
        methods: {
            ...
            async open(uuid) {
                try {
                    ...
                    // Checking permission
                    authService.assertEditActionGrantedOn("Scenario");
                    ...
                    const breedResult = await gameScenarioService.atEditListBreed(uuid);
                    const siteResult = await gameScenarioService.atEditListSite(uuid);
                    ...
                    await this.$refs.ScenarioImage.openFile('http://localhost:8081/data/scenario/' + uuid + '/image/main');
                } catch(exp) {
                    await TController.displayExceptionMessages(exp);
                    this.close();
                }
