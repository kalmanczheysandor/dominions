<template>
    <TDialog ref="Dialog" title="New dog" :closeable="true" @whenDialogClosed="whenParentDialogClosed">
                    ...
                    <v-row>
                        ...
                        <v-col>
                            ...
                            <v-autocomplete
                                ...
                                label="Breed" item-value="uuid" item-title="name"
                            ...
                            <v-autocomplete
                                ...
                                label="Site" item-value="uuid" item-title="name"
    ...
    export default {
        ...
        methods: {
            ...
            async open() {
                try {
                    // Checking permission
                    authService.assertAddActionGrantedOn("Dog");

                    // Retrieve: meta record(s)
                    const breedResult = await dogService.atAddListBreed();
                    const siteResult = await dogService.atAddListSite();
