<template>
    <TDialog ref="Dialog" title="New Admin-User" :closeable="true" @whenDialogClosed="whenParentDialogClosed">
...
export default {
    ...
    methods: {
        ...
        async open() {
            try {
                // Checking permission
                authService.assertAddActionGrantedOn("Account.Admin.User");

                // Attempt to retrieve data
                const permissionGroupResult = await adminUserService.atAddListPermissionGroup();
