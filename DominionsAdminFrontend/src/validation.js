...
export const PositiveNumberFieldRuleWithZero = (value) => {
    if(isNaN(value)) {
        return 'Field must be in number format!';
    }
    if(!(value>=0)) {
        return 'Field must be 0 or grater number!';
    }
    return true;
};

export const PositiveNumberFieldRuleWithoutZero = (value) => {
    if(isNaN(value)) {
        return 'Field must be in number format!';
    }
    if(!(value>0)) {
...
export const TextareaFieldRule = (value) => {
    const max = 200000;
    const min = 0;
