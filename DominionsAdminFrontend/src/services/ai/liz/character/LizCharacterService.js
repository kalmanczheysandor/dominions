...
class LizCharacterService extends TService {
    #baseUrl = super.extendWithBaseUrl('/ai/liz/character');
    #permissionResource = 'Ai.Liz.Character';
...
const lizCharacterService = new LizCharacterService();

// Exports
export default lizCharacterService;
export {LizCharacterService, lizCharacterService};
