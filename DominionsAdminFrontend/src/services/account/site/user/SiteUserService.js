...
class SiteUserService extends TService {
    #baseUrl = super.extendWithBaseUrl('/account/site/user');
    #permissionResource = 'Account.Site.User';
...
export {SiteUserService, siteUserService};
