<template>
    <GameBoard v-model="GameBoardComponent.board"
        ...
        methods: {
            async init() {
                try {
                    ...
                    const gameInitData = await gameService.init({
                    ...
                    console.log("iiii");
                    console.log(gameInitData.gameMapState);
                    this.GameBoardComponent.board.state = gameInitData.gameMapState;
                    this.GameBoardComponent.board.view = gameInitData.gameMapView;
            ...
            async loadList() {
                try {
                    ...
                    // List all rows
                    // const result = await gameLobbyService.listAll();
                    //
                    // // Inject values
                    // this.LobbyListComponent.selected = [];
                    // this.LobbyListComponent.rows = result.data;
