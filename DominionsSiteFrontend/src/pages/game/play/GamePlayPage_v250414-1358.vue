<template>
    <GameBoard ref="GameBoardComponent" v-model="GameBoardComponent.board"
        ...
        methods: {
            async init() {
                try {
                    ...
                    this.$refs.GameBoardComponent.loadPlayState({
                        settings: {
                            playerColors: {
                                0: 'red',
                                2: 'green',
                        ...
                        state:gameInitData.gameMapState,
                        view: gameInitData.gameMapView,
                    })
