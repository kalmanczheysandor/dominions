<template>
    ...
    <v-row>
        ...
        <v-col v-for="item in PlayListComponent.rows" :key="item.uuid" cols="12" lg="6" md="6" sm="12">
            ...
            <v-card dense class="d-flex flex-no-wrap  LobbyCard">
                <v-avatar class="ma-0" rounded="0" size="250" title="Join">
                    <v-img
                            :src="backendConfiguration.BACKEND_BASE_URL+'/game/scenario/'+item.scenarioUuid+'/image/main'"
