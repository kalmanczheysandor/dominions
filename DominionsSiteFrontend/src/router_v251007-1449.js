...
export const router = createRouter({
    ...
    routes: [
        {name: 'Account.Login', path: '/login', component: LoginPage, meta: {title: 'Login', requiresAuth: false,cssName:'LoginPage'}}, // our-domain.com/teams => TeamsList
        {name: 'Account.SignUp', path: '/signup', component: AccountSignUpPage, meta: {title: 'Account registration', requiresAuth: false,cssName:'AccountSignUpPage'}},
        {name: 'Account.SignUp.Verification', path: '/signup/verification/:verificationToken', component: AccountSignUpVerificationPage, meta: {title: 'Account registration verification', requiresAuth: false,cssName:'AccountSignUpVerificationPage'}},
        ...
        {name: 'Account.Profile', path: '/account/settings', component: ProfilePage, meta: {title: 'Profile page', requiresAuth: true}},
