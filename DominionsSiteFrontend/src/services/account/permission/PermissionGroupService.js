...
class PermissionGroupService extends TService {
    #baseUrl = super.extendWithBaseUrl('/data/account/permission');
    #permissionResource = 'Account.PermissionGroup';
...
export {PermissionGroupService, permissionGroupService};
