<template>
    <div class="Image-Upload-wrapper Image-upload">
        ...
        <div class="CroppieBox" @click.stop="eventBoxClicked">
            <div id="croppie" @click.stop="onImageClick"></div>
        </div>
        ...
        methods: {
            ...
            resetCroppie() {
               this.destroyCroppie();
                ...
                // Reinitialize Croppie with the original or new image
                this.setUpCroppie(); // Setup Croppie with fresh settings
            },
            ...
            onFileChange(event) {
                ...
                if (file) {
                    ...
                    reader.onload = (e) => {
                        ...
                        //
                        // this.croppie.bind({
                        //     url: image // Bind the new image to Croppie
                        // });
                    };
