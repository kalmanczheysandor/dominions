    ...
    export default {
        ...
        methods: {
            ...
            registrateImage(imageFile) {
                ...
                this.$refs.Container.appendChild(nodeData.frameNode);
                let obj = {
                    key: itemKey,
                    imageFile: imageFile,
            ...
            clearDropArea() {
                ...
                let nodesList = this.$refs.Container.querySelectorAll(".ImageFrame");
                if(nodesList != null) {
...
<style>
    ...
    .TUploadZone > .Container::-webkit-scrollbar {
        width: 10px;
        height: 10px;
        background-color: #f2f2f2;
    }

    .TUploadZone > .Container::-webkit-scrollbar-track {
        width: 10px;
        height: 10px;
        background-color: #f2f2f2;
    }

    .TUploadZone > .Container::-webkit-scrollbar-thumb {
        background-color: #e6e6e6;
    }

    .TUploadZone > .Container::-webkit-scrollbar-thumb:hover {
