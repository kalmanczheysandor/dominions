<template>
    ...
    <div v-if="(configuration.view !== null)">
        ...
        <div id="MapPanel" style="">
            <button type="button" title="Reserve" :disabled="action.targetKey!=null" id="ReserveIcon" class=" mdi-piggy-bank-outline mdi"></button>
            <button type="button" title="Attack" :disabled="action.targetKey==null" id="AttackIcon" class="mdi-sword mdi"></button>
            ...
            <svg id="MapSvg" viewBox="0 0 1300 850" preserveAspectRatio="xMidYMid meet" style="">
                ...
                <g transform="translate(0,0)">
                    <g transform="scale(1,1)">
                        <!-- CONTINENT OUTLINE -->
                        <polygon v-for="(continentItem, continentIndex) in configuration.view.foreground.continents "
...
<!--            <div id="ActionBox">-->
<!--                <button :disabled="action.targetKey!=null" id="NextTurnButton" class="" type="button"-->
...
<!--                <input :disabled="action.targetKey==null" id="TroopsInput" ref="TroopsInput" type="text"-->
<!--                       placeholder="Troops" v-model="action.troops">-->
<!--                <button :disabled="action.targetKey==null" id="AttackButton" class="btn btn-basic" type="button"-->
<!--                        @click="eventAttackAction">-->
<!--                    Attack-->
<!--                </button>-->
<!--            </div>-->
...
#MapPanel #AttackIcon:disabled {
    opacity: 0.2;
    cursor: not-allowed;
}

#MapPanel #TroopsInput {
    position: absolute;
    left: 20px;
    top: 170px;
