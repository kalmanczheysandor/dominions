<template>
    ...
    <div v-if="(configuration.view !== null)">
        ...
        <nav id="ActionBar" >
            [turn:{{turn}}] [Target:#{{action.targetKey}}]
            <div id="ActionBox">
                <button :disabled="action.targetKey!=null" id="NextTurnButton" class="" type="button" @click="eventNextTurnAction">
                    Reserve
                </button>
    ...
    <div class="BackDropLayer" v-if="isRecruiting">
