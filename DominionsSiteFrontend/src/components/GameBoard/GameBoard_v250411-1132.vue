<template>
    ...
    <div id="PlayersPanel">
        <table>
            <tr v-for="(playerItem, playerIndex) in modelValue.players" :key="'PlayersPanel-Row-'+playerIndex">
                ...
                <g transform="scale(1.0,1.0)">
                    ...
                    <g transform="translate(+250,0)">
                        <g transform="scale(0.8,0.8)">
                            ...
                            <!--COUNTRIES-->
                            <polygon v-for="(countryItem, countryIndex) in modelValue.countries" :key="'Country-'+countryIndex" ffw-type="Country" :ffw-country-key="countryItem.countryKey" :class="countryItem.classes" :points="countryItem.points" :ref="'Country-' + countryItem.countryKey" @click="eventCountryIsChosen(countryItem.countryKey)"/>
...
<script>
    ...
    export default {
        ...
        computed: {
            getCellCount() {
                return Object.keys(this.modelValue.cells).length
            }
        },
        data() {
            return {
        ...
        methods: {
            ...
            findCountryData(countryIndex) {
                this.assertCountryExistAtIndex(countryIndex);
                return this.modelValue.countries.find(country => country.countryKey == countryIndex);
            },

            
            isCellExistAtIndex(cellIndex) {
                if(cellIndex in this.modelValue.cells) {
                    return true;
                }
                return false;
            },
            ...
            findCellData(cellIndex) {
                this.assertCellExistAtIndex(cellIndex);
                return this.modelValue.cells[cellIndex];
            },


            isPlayerExistAtIndex(playerIndex) {
                if(playerIndex in this.modelValue.players) {
                    return true;
                }
                return false;
            },
            ...
            findPlayerData(playerIndex) {
                this.assertPlayerExistAtIndex(playerIndex);
                return this.modelValue.players[playerIndex];
            },
        },
        created() {
            this.eventInit();
