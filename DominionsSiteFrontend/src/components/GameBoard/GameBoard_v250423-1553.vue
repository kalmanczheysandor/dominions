<template>
    ...
    <div class="BackDropLayer" v-if="(isGamePlaying|| isGameEnded) && amIDead">
        <div class="TDialog GlassDialog">
            <div class="Body" style="text-align: center">
                <p style="font-size: 30px; font-weight: bold">GAME OVER</p>
                <p>Sorry! You lost the game!</p>
                <p v-if="!isGameEnded">You are dead.<br>You can observe the game play.</p>
                <p v-else>
                    The winner player is:{{this.findWinnerPlayerName()}}
                </p>
            </div>
        </div>
    </div>
    <div class="BackDropLayer" v-if="isGameEnded && amIWinner">
        <div class="TDialog GlassDialog">
            <div class="Body" style="text-align: center">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            amIDead() {
                const playerData = this.gatherPlayerData(parseInt(this.yourIndex));
                if(!playerData.isAlive) {
                    return true;
                }
                return false;
            ...
            amIWinner() {
                if(this.yourIndex != null && this.findWinnerPlayerIndex() == this.yourIndex) {
                    return true;
                }
                return false;
            }
